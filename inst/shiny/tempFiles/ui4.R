...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    uiOutput("choose_topics"),
    
    #matrixInput("topicsPoints", c("Desc", "Prob"), matrix(rep(uiOutput("topics"), nrow=2))),
    
    #matrixInput('topics.points', 'Topics', matrix(rep(uiOutput("topics"), nrow=2)),
    
    uiOutput("points_topics"),
    
    matrixInput("foo" , 'foo', data.frame(cbind(uiOutput("my.topics"), 0), ncol=2)),
