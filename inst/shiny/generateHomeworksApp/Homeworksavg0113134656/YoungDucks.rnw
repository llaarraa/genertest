...
@
A genetically modified mouse does not survive the first month of life with probability \Sexpr{p} . \\\begin{itemize}
\item  We planned an experiment that included \Sexpr{n} mice. What is the probability that after a month not more than a mouse will survive? 
